...
public class SagaDeadLetterQueueHandler {
    ...
    @KafkaListener(topics = KafkaConfig.PRESCRIPTION_RECEIVED_DLQ, groupId = "medical-dlq-handler")
    ...
    @KafkaListener(topics = KafkaConfig.PAYMENT_PROCESSED_DLQ, groupId = "medical-dlq-handler")
